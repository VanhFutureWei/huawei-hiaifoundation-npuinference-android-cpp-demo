 ...
 */
#ifndef FRAMEWORK_TENSOR_COMPATIBLE_HIAI_AIPP_PARA_H
#define FRAMEWORK_TENSOR_COMPATIBLE_HIAI_AIPP_PARA_H
#include <stdint.h>
#include <memory>
...
class IAIPPPara;
class HIAI_TENSOR_API_EXPORT AippPara {
public:
    AippPara();
    ~AippPara();
