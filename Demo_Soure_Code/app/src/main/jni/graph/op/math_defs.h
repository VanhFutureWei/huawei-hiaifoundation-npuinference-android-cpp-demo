 ...
 *    100.310.010.013
 */
const char* const EXP_ATTR_BASE = "base";
const char* const EXP_ATTR_SCALE = "scale";
const char* const EXP_ATTR_SHIFT = "shift";
 ...
 *    100.500.010.010
 */
const char* const ATTR_NAME_X1_QUANT_TYPE = "x1_quant_type";
const char* const ATTR_NAME_X2_QUANT_TYPE = "x2_quant_type";
const char* const ATTR_NAME_X1_QUANT_SCALE = "x1_quant_scale";
const char* const ATTR_NAME_X1_QUANT_OFFSET = "x1_quant_offset";
const char* const ATTR_NAME_X2_QUANT_SCALES = "x2_quant_scales";
 ...
 *    100.500.010.010
 */
const char* const GEMM_ATTR_ALPHA = "alpha";
const char* const GEMM_ATTR_BETA = "beta";
const char* const GEMM_ATTR_TRANSPOSEA = "transpose_a";
const char* const GEMM_ATTR_TRANSPOSEB = "transpose_b";
 ...
 *    100.310.010.013
 */
const char* const LOG_ATTR_BASE = "base";
 ...
 *                      .set_attr_keep_dims(false);
 */
const char* const REDUCEMEAN_ATTR_KEEP_DIMS = "keep_dims";
 ...
 *    100.500.010.011
 */
const char* const REDUCELOGSUMEXP_ATTR_KEEPDIMS = "keepdims";
const char* const REDUCELOGSUMEXP_ATTR_AXES = "axes";
 ...
 *    100.500.010.011
 */
const char* const REDUCEL2D_ATTR_KEEP_DIMS = "keep_dims";
const char* const REDUCEL2D_ATTR_AXES = "axes";
 ...
 *   100.500.010.010
 */
const char* const REDUCTION_ATTR_OPERATION = "operation";
const char* const REDUCTION_ATTR_AXIS = "axis";
const char* const REDUCTION_ATTR_COEFF = "coeff";
